...
const platform_shared = const MethodChannel('com.laodev.simplechat/shared');

void getSharedData(Function(String, String) callback) async {
  platform_shared.setMethodCallHandler((call) {
    print('Shared Text ===> ${call.arguments}');
